...
bool server::reply(std::string name, int cfd, bool flag)
{
    ...
    if (flag == true)
    {
        ...
        if (!chan_opers.empty())
        {
            rpl = ":" + cl[cfd].get_nickname() + "!~" + cl[cfd].get_username() + "@" + cl[cfd].get_clientip() + " JOIN :"+ name + "\r\n";
        ...
        else if (chan_opers.empty())
        {
            rpl = ":" + cl[cfd].get_nickname() + "!~" + cl[cfd].get_username() + "@" + cl[cfd].get_clientip() + " JOIN :"+ name + "\r\n";
            rpl += ":" + cl[cfd].get_host() + " 353 " + cl[cfd].get_nickname() + " = " + name + " :" + chan_members + "\r\n";
            rpl += ":" + cl[cfd].get_host() + " 366 " + cl[cfd].get_nickname() + " " + name + " :End of /NAMES list.";
            rpl += "\r\n";
        }
